...
$config['db_dsnw'] = 'mysql://root:kj9023bng6752bjw@localhost/roundcube';
// self::$mysqli = new mysqli(hostname: 'localhost', username: 'root', password: 'kj9023bng6752bjw', database: 'onchat');
